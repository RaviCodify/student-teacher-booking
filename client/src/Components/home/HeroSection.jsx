    ...
    <section className="hero-section d-flex flex-column align-items-center bg-dark py-3 mt-4" data-bs-theme="dark">
      ...
      <div className="container text-center text-white mt-3">
        ...
        <div className="my-2 d-flex justify-content-between">
          <Link to="/teachers" className="btn btn-dark text-black"style={{backgroundColor:"#e18b74"}}>Find a Teacher</Link>
          <Link to="/teacher/signup" className="btn btn-dark text-black"style={{backgroundColor:"#e18b74"}}>Join as a Teacher</Link>
        </div>
      </div>
    </section>
  );
